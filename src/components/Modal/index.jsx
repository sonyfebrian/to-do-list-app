            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              <div className="flex items-start justify-between py-3 bg-[#F6F6F6] px-3 border-slate-200 rounded-t">
                ...
                <button
                  ...
                  onClick={() => dispatch(modalActions.closeModalCreateTask())}
                  aria-label="Close"
                >
                  <svg
...
Modal.propTypes = {
  todos: PropTypes.array.isRequired, // You can specify the prop type and if it's required
